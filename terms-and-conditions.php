					...
					<div class="col-md-12">
						<div class="box-content">
							...
							<div class="row">
									<div class="container">
								<div class="col-md-12">
										<h1>Garnier Australia Terms & Conditions</h1>
								<div class="p">
										<p>
											<b>TERMS OF USE</b><br>
Thank you for accessing www.garnier.com.my (the "Website"). Please read these terms and conditions ("Terms") before using the Website which is operated by L’Oréal Malaysia Sdn. Bhd. whose business address is at No. 8, 13A & 15, Uptown 2, No. 2, Jalan SS21/37, Damansara Uptown, 47400 Petaling Jaya, Selangor Darul Ehsan ("L’Oréal"). By using the Website, you signify your acceptance of the Terms in consideration of which L’Oréal provides you with access. From time to time L’Oréal may modify the Terms. Accordingly, please continue to review the Terms whenever accessing or using the Website. Your use of the website following any such change constitutes your agreement to follow and be bound by the terms as changed. If at any time you do not wish to accept the Terms, you may not use the Website. From time to time L’Oréal may run competitions and promotions via the Website. Separate terms and conditions will be posted where applicable governing such competitions and promotions.</p>


<p><b>NO RELIANCE</b><br>
...
<p><b>INTELLECTUAL PROPERTY</b><br>
	The Website, including (but not limited to) text, content, software, video, music, sound, graphics, photographs, illustrations, artwork, photographs, names, logos, trademarks, service marks and other material ("Content") is protected by copyrights, trademarks and/or other proprietary rights. The Content includes both content owned or controlled by L’Oréal and content owned or controlled by third parties and licensed to L’Oréal. All individual articles, reports, and other elements making up the Website may be copyright works. You agree to abide by all additional copyright notices or restrictions contained in the Website.<br><br>

You may not use any of L’Oréal's trademarks or trade names without L’Oréal's prior express written consent and you acknowledge that you have no ownership rights in and to any of those names and marks.<br><br>
...
<p><b>LICENCE AND DOWNLOAD RIGHTS </b><br>
	You acquire no rights or licences in or to the Website and/or the Content other than the limited right to use the Website in accordance with these Terms and to download on the terms set out in this section. Other than as set out in this section you may not copy, reproduce, recompile, decompile, disassemble, reverse engineer, distribute, publish, display, perform, modify, upload to create derivative works from, transmit, or in any other way exploit any part of the Website.<br><br>
Download is permitted by L’Oréal provided only that:<br><br>
 (i) you make no more than one printed copy of such download and no further copies of such printed copy are made;
 <br><br>(ii) you make only personal, non-commercial use of such download and/or printed copy; and
 <br><br>(iii) you retain on such download and/or printed copy all copyright notices and shall remain bound by the terms of such wording and notices. Additionally, you may not offer for sale or sell or distribute over any other medium (including distribution by over-the-air television or radio broadcast or distribution on a computer network) the Content or any part thereof. You may not make any part of the Website available as part of another website, whether by hyperlink framing on the internet or otherwise. The Website and the information contained therein may not be used to construct a database of any kind, nor may the Website be stored (in its entirety or in any part) in databases for access by you or any third party or to distribute any database websites containing all or part of the Website.

</p>

<p><b>COOKIES</b><br>
	If you use our Website, we may collect your IP address and your browser type for system administration and/or statistical purposes but without collecting any other individual information. A ‘cookie’ may be placed on your device in order to allow you to use the Website.
<br><br>

A ‘cookie’ is a small piece of data which may be downloaded and stored by your device whenever you access the Website or related online facilities. Cookies allow L’Oreal to recognize your device while you are visiting our Website or related online facilities as a previous user but this does not enable us to collect any personally identifiable information from your device.<br><br>
We will mainly use cookies to track activity on our Website and to recognize you the next time you visit our Website and to display contents that may match your interests.<br><br>

Web browsers are usually set by default to accept cookies but you may easily change this by modifying the settings of your browser and/or your own device whenever viewing content over the internet. However, please note that should you choose to disable cookies, you may be unable to use parts of our Website and this may affect your enjoyment and use of our Website or online facilities. 
...
<br><br>
b) Flash Cookies. L’Oréal uses Flash files to deliver part of its content, such as Video Player, throughout the site. To improve user experience, local shared objects – or Flash Cookies as they are commonly known – are employed to provide features such as auto-resume and for saving your preferences. Flash Cookies are stored in your terminal much in the same way as cookies are, however it is not possible to manage them at browser level in the same way.<br><br>

How to disable Flash Cookies: The Adobe website provides comprehensive information on how to delete or disable Flash cookies, see www.adobe.com/products/flashplayer/security for details. Restricting the use of Flash Cookies may affect your enjoyment of this site.

</p>

<p><b>NO WARRANTY</b><br>
	The Website and the Content are provided "as is" excluding any warranties of any kind, either express or implied, to the fullest extent permissible pursuant to applicable law including (but not limited to) the exclusion of warranties of title, merchantability, satisfactory quality, fitness for a particular purpose and non-infringement of proprietary or third party rights. L’Oréal further accepts no responsibility or liability for functions contained on the Website and makes no warranties that the Website will operate uninterrupted or error-free or that defects will be corrected. 
...
<br><br>
In no event will L’Oréal, to the fullest extent permitted by applicable law, be liable to you or any third party for any direct, special, indirect, consequential or incidental damages, exemplary or lost profits, or any other damages of any kind whether based on warranty, contract, tort (including negligence) or otherwise, even if L’Oréal has been advised of the possibility thereof, arising from your use of the website. 
</p>

<p><b>CHANGES TO THE WEBSITE </b><br>
...
(iv) any deletions, additions, insertions, or alterations to, or any unauthorised use of, the Website by you; or
 ...
 References in this section of the Terms to your use of the Website shall be deemed to include any use by a third party where such a third party accesses the Website using your computer. You agree to pay L’Oréal, its employees, representatives, and agents any and all costs, damages, and expenses (including reasonable legal fees) awarded against any of them or otherwise incurred by any of them in connection with or arising from any such third party claim, suit, action or proceeding attributable to any such third party claim.
</p>

<p><b>PRIVACY</b><br>
Please refer to our Personal Data Protection and Privacy Policy Notice. 
</p>
<p><b>TRANSMISSION AND FEEDBACK OF INFORMATION</b><br>
Any information you transmit through this Website is subject to L’Oréal's privacy policy and remains L’Oréal’s property. You are prohibited from transmitting to or from this Website any unlawful, threatening, libellous, defamatory, obscene, inflammatory or pornographic material or other material that could give rise to any civil or criminal liability under law. 
</p>
<p><b>LOCAL LAWS AND REGULATIONS</b><br>
...
The Terms are governed by the laws of Malaysia and the parties submit to the exclusive jurisdiction of the Malaysian courts. 
</p></div>
